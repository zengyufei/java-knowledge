...
public class P2_消费者 {
    ...
    public static void 监听队列接收mq消息() {
        ...
        try {
            ...
            信道.basicConsume(P0_常量.队列名称, true,
                    (consumerTag, message) -> System.out.println(P2_消费者.class.getSimpleName() + "接收到消息: " + new String(message.getBody(), StandardCharsets.UTF_8)),
                    consumerTag -> System.out.println(P2_消费者.class.getSimpleName() + "消息消费被中断,取消消费消息"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        信道.basicConsume(P0_常量.队列名称, true, (customerTag, message) -> {
            System.out.println(P2_消费者.class.getSimpleName() + "接收到消息: " + new String(message.getBody(), StandardCharsets.UTF_8));
        }, (customerTag) -> {
