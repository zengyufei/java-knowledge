 ...
 * @author zengyufei
 */
public class C6_登录响应处理器 extends SimpleChannelInboundHandler<C3_登录响应数据包> {

    @Override
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        Console.log("开始登录...");
        C3_登录请求数据包 登录请求数据包 = new C3_登录请求数据包();
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, C3_登录响应数据包 登录响应数据包) throws Exception {
