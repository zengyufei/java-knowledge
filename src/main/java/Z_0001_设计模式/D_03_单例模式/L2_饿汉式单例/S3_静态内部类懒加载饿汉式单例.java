 ...
 */
public class S3_静态内部类懒加载饿汉式单例 {

    private S3_静态内部类懒加载饿汉式单例() {
    }

    private static class 静态内部类 {
        private final static S3_静态内部类懒加载饿汉式单例 INSTANCE = new S3_静态内部类懒加载饿汉式单例();
    }
     ...
     */
    public static S3_静态内部类懒加载饿汉式单例 getInstance() {
