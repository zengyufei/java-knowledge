import com.zyf.cloud.S51_C1_服务注册中心_启动器;
...
@SpringBootTest(classes = S51_C1_服务注册中心_启动器.class)
@AutoConfigureMockMvc
public class S51_C1_服务注册中心_启动器Tests {
    ...
    public void 测试请求1() throws Exception {
        ...
        String content = requestGetAndReturn(uri);
        Assert.isTrue(content.contains("dev"), "返回值错误");
    }

    @Test
    public void 测试请求2() throws Exception {
        String uri = "/dev/config-client.yml";
        String content = requestGetAndReturn(uri);
        Assert.isTrue(content.contains("default"), "返回值错误");
    }
